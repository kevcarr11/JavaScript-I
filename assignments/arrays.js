...
function challenge1 (inventory2, foo){
    for (let i = 0; i < inventory2.length; i++){
        if(inventory2[i].id === foo) {
            return "car " + foo + " is a " + inventory2[i].car_year + ", " + inventory2[i].car_make + " " + inventory2[i].car_model;
        }
    }
}
console.log(challenge1(inventory, 18));

// ==== Challenge 2 ====
// The dealer needs the information on the last car in their inventory.  What is the make and model of the last car in the inventory?  Log the make and model into the console.
let lastCar = function(inventory3){
return inventory3[inventory3.length - 1].car_make + ", " + inventory3[inventory3.length -1].car_model;
};
...
let carModels = function (inventory3){
    return inventory3[inventory3.length - 1].car_model;
